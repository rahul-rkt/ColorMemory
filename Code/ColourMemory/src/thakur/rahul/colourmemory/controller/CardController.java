...
public class CardController {
	...
	private int matchCounter = 0; // TODO change to 0
	...
	/**
	 * Gives user a new set of cards to open. 
	 * Designed to be used for Time Trial Game Mode
	 * Input: ImageView v -- the last card to be opened. Needed for flipAllCards method
	 */
	 ...
	 * Input: ImageView v -- the last card to be opened.  We need to first finish 
	 * 						 the card flipping up animation before flipping this card down.
	 */
	...
	/**
	 * Sets up new game.
	 * This is called by the AnimationController when all flipping is done.
	 * Otherwise, users will have a short time frame where he can see the new card set before they're flipped down.
	 */
