...
public class GameBoardActivity extends Activity implements NewHighScoreFragmentToActivityCommunicator, HighScoreListFragmentToActivityCommunicator {
	...
	private int[] card_backs = { R.id.R0C0_0, R.id.R0C1_0, R.id.R0C2_0, R.id.R0C3_0,
								 R.id.R1C0_0, R.id.R1C1_0, R.id.R1C2_0, R.id.R1C3_0,
								 R.id.R2C0_0, R.id.R2C1_0, R.id.R2C2_0, R.id.R2C3_0,
								 R.id.R3C0_0, R.id.R3C1_0, R.id.R3C2_0, R.id.R3C3_0,
								};
